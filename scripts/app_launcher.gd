...
const CLIENT_SCENE: String = "res://scenes/server_screen.tscn"
const SERVER_SCENE: String = "res://scenes/dedicated_server.tscn"
...
func _open_start_scene() -> void:
	...
	if executable_name.contains("server") or args.has("--server"):
